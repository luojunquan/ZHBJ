...
import com.news.zhbj.slid.SlidingMenu.OnClosedListener;
import com.news.zhbj.slid.SlidingMenu.OnOpenedListener;
...
public class CustomViewAbove extends ViewGroup {
	...
	void smoothScrollTo(int x, int y, int velocity) {
		...
		final float distance = (float) (halfWidth + halfWidth *
